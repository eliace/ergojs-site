...
//		this.events = new Ergo.events.Observer(this);
	...
	factory: function(o, type) {
		...
		return $.ergo( [this.options[default_child], o], null, this._context );
...
Ergo.declare('Ergo.layouts.Center', 'Ergo.core.Layout', {
	...
	update: function() {
		...
		var w = this._widget.content.el.width();
		var h = this._widget.content.el.height();
		
		this._widget.content.el.css({
			'margin-left': -w/2,
			'margin-top': -h/2
		});
